...
from langgraph_outdoor_activity_agent.agent import get_graph_closure
...
async def lifespan(app: FastAPI):
    """Initialize the Outdoor Activity agent graph on startup and clear it on shutdown.
...
# Create FastAPI app
app = FastAPI(
    title="LangGraph Outdoor Activity Agent API",
    description="FastAPI service for LangGraph Outdoor Activity Agent",
    lifespan=lifespan,
)
